...
def main():
    ...
    # 3. Адаптація для Instagram/Buffer (якщо хоча б одна платформа активна)
    instagram_text = None
    if instagram_enabled or buffer_enabled or drive_enabled:
    ...
    # 9. Збереження в Google Drive (якщо налаштовано)
    if drive_enabled:
